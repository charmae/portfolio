    ...
    <main className="flex min-h-screen flex-col items-center   ">
      ...
      <div className="relative flex place-items-center  justify-between self-center items-center  flex-col sm:flex-row w-full md:w-5/6 xl:w-2/3 px-4 sm:px-0 h-full">
        ...
        <div className="place-items-center p-5 w-3/5 ">
         ...
         Greetings! I&apos;m Charmae, a Software Engineering Specialist with over ten years in the IT industry. 
         I specialize in Java Enterprise Backend & Integration, along with Front-End Development, 
         leveraging my proficiency in Java EE, Spring Framework, Spring Boot, Angular, JUnit, MuleSoft, MUnit, SonarQube, and GIT.
         </div>
      ...
      <div id="skillset" className="w-full min-h-screen flex flex-col justify-center items-center py-5">
    
      <div
          className="self-center text-center w-full sm:w-2/3 xl:w-1/2  sm:px-0"
        >
      ...
      <div className="w-full sm:w-full flex  hover:shadow-lg p-5  "
          >
            ...
            <div className="w-2/3 xl:w-3/4 px-5">
              <h3
                className="tracking-wide  font-bold text-2xl  mb-0 w-4/5" 
              >
                Java   
              </h3>
          ...
          >
            ...
            <div className="w-2/3 xl:w-3/4 px-5 ">
              <h3
                className="tracking-wide  font-bold text-2xl  mb-0"
              >
                Spring
              </h3>
              <div className="font-light text-gray-500 text-lg">
          ...
          >
            <div className="w-1/4 xl:w-1/4">
              <img
                src="/skillset/mulesoft-skill.png"
                alt="MuleSoft"
          ...
          >
            <div className="w-1/4 xl:w-1/4">
              <img
                src="/skillset/javascript-skill.svg"
                alt="JavaScript"
                className="w-16 block sm:mx-auto"
              />
            </div>
          ...
          >
            <div className="w-1/4 xl:w-1/4">
              <img
                src="/skillset/typescript-skill.png"
                alt="TypeScript"
                className="w-16 block sm:mx-auto"
              />
            </div>
          ...
          >
            <div className="w-1/4 xl:w-1/4">
              <img
                src="/skillset/angular-skill.svg"
                alt="HL7"
                className="w-16 block sm:mx-auto"
              />
            </div>
        ...
        <div
          className="self-center text-center w-full sm:w-2/3 xl:w-1/2 px-1 sm:px-0"
        >
      ...
      <a href="https://www.credly.com/badges/ef43cbcc-f032-43d0-b4fb-05809475ad41/public_url" target="_blank" >
            <div className="w-full place-items-center ">
              <img
                src="/certificate/aws-practitioner-cert.png"
                alt="AWS Certified Cloud Practitioner"
                className="w-24 xs:w-10 block sm:mx-auto  text-align-center " />
          </div> 

          <div className="w-full place-items-center pt-2 ">
           <p className="font-light text-gray-500 text-xs text-center"> AWS Certified Cloud Practitioner</p>
          </div>
          </a>
      </div>
      ...
      <a href="https://www.credly.com/badges/0d6ff17f-53d7-4c87-a4f5-12d79b83e888/public_url" target="_blank" >
            <div className="w-full">
              <img
                src="/certificate/java-cert.png"
                alt="Oracle Certified Java 8 Programmer"
                className="w-24 block sm:mx-auto" />
          </div> 

          <div className="w-full place-items-center pt-2 ">
           <p className="font-light text-gray-500 text-xs text-center"> Oracle Certified Java 8 Programmer</p>
          </div>
          </a>
      </div>
      ...
      <div className="w-full sm:w-full flex-row hover:shadow-lg p-5">
      <a href="https://drive.google.com/file/d/1MxQ2bD3T2hPIQfVIqF3SEs4QTXMZFyaz/view?usp=sharing" target="_blank" >

            <div className="w-full">
              <img
                src="/certificate/sf-ai-cert.png"
                alt="Salesforce Certified AI Associate"
                className="w-24 block sm:mx-auto" />
          </div> 

          <div className="w-full place-items-center pt-2 ">
           <p className="font-light text-gray-500 text-xs text-center">Salesforce Certified AI Associate</p>
          </div>
          </a>
      </div>

      <div className="w-full sm:w-full flex-row hover:shadow-lg p-5">
      <a href="https://drive.google.com/file/d/1e0xeHjphW5CwBaprNoiEerFRxxZYljzH/view?usp=sharing" target="_blank" >

            <div className="w-full">
              <img
                src="/certificate/mule-ai-cert.png"
                alt="MuleSoft Certified Associate Integration"
                className="w-24 block sm:mx-auto" />
          </div> 

          <div className="w-full place-items-center pt-2 ">
           <p className="font-light text-gray-500 text-xs text-center"> MuleSoft Certified Associate Integration</p>
          </div>
          </a>
      </div>
      ...
      <div className="w-full sm:w-full flex-row hover:shadow-lg p-5">
      <a href="https://drive.google.com/file/d/1WuW6uZgwAxSLgXe-cZPRq8tRdBgDsKtn/view?usp=sharing" target="_blank" >

            <div className="w-full">
              <img
                src="/certificate/mule-dev-cert.png"
                alt="MuleSoft Certified Developer"
                className="w-24 block sm:mx-auto" />
          </div> 

          <div className="w-full place-items-center pt-2 ">
           <p className="font-light text-gray-500 text-xs text-center"> MuleSoft Certified Developer</p>
          </div>
          </a>
      </div>
