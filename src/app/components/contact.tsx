        ...
        <div className=" relative place-items-start w-2/3  items-start bg-red">
          <div className="mx-auto w-full max-w-[600px]">
            <form className="for" onSubmit={handleSubmit}>
              ...
              <div>
                <ReCAPTCHA ref={refCaptcha} sitekey={process.env.EMAILJS_RECAPTCHA as string} />
                <button
                  className="hover:shadow-form rounded-full bg-gray py-3 px-8 text-base font-semibold text-white outline-none"
                  type="submit"
                >
                  Submit
                </button>
